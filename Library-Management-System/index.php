...
<head>
    ...
    <style>
        ...
        .five input[type="submit"], .five input[type="button"] {
            font-size: 22px;
            text-align: center;
            border: none;
            height: 40px;
...
<div class="box">
    <table style="font-size: 16pt" align="center" width="100%" height="100%">
        <tr>
            <td style="color: blue">
                <h1 align="center"><marquee><u>Welcome To online Library System</u></marquee></td></h1>
        </tr>
        <tr>
...
<form method="post" action="">
    <div class="boxtwo" style="border: solid 1px #CF0403; border-radius: 10px; width: 73.5%; height: 360px; margin-left: 13%; margin-top: 15px; background-color: white">
        ...
        <fieldset align="center"
                  style="background: rgba(0, 0, 0, 0.38); color: blue; width: 300px; height: 300px; margin-right: 45px;"
                  class="five">
            <div class="boxfour">
            ...
            <table
                    style="font-size: 16pt; width: 300px; height: 50px; margin-right: 45px; margin-top: 25px; text-align: center">
                <tr>
                    <td><br></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="center"><input type="button" value="HOME" onclick="window.location.href='http://localhost:8072/sbwebpage';"></td>
                </tr>
                <p style="color: red; font-weight: bold; font-size: 17px; text-align: center; background: rgba(255, 255, 255, 0.8)"><?php echo $error ?></p>
                <tr>
...
<div class="boxthree"
     style="background-color: orange; border: solid 2px orange; border-radius: 10px; width: 73.5%; height: 40px; margin-left: 13%; margin-top: 15px">
